    ...
    <>
      <nav className="navbar navbar-dark navbar-expand-lg bg-dark sticky-top">
        <div className="container-fluid">
          <Link className="navbar-brand" to="/">
            <i className="bi bi-music-note-list mx-3"></i> VMusic
          </Link>
          <div>
            <button
              type="button"
          ...
          >
            ...
            <a href="login.js">
              <button className="btn btn-outline-success" style={{margin: "10px", color:"white"}}>
                Log In
              </button>
            </a>
          </div>
      ...
      >
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="likedMusicModalLabel" style={{color:"white"}}>
                Liked Music
              </h1>
              <button
                type="button"
